...
const UpdateInvoiceFGIIT: React.FC = () => {
	...
	const handleUpdateInvoice = async (event: any) => {
											...
											<div className='bill-name-date px-2'>
												...
												<p className=''>
													...
													<span id='inv-due'>
														...
														{dueAmount
															? dueAmount
															: invoiceData.net_amount - invoiceData.paid_amount || '-'}
													</span>
												</p>
												<p className=''>
...
export default UpdateInvoiceFGIIT
